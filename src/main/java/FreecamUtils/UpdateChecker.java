...
public final class UpdateChecker {
    ...
    public static final  VersionScheme VERSION_SCHEME_DOUBLE = (oldversion,newversion) -> {
        ...
        return (newver > oldver) ? newversion : oldversion;
    ...
    public static UpdateChecker init(JavaPlugin plugin, int pluginID) {
        return init(plugin, pluginID, VERSION_SCHEME_DOUBLE);
    }
